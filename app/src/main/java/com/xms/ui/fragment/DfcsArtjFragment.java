...
public class DfcsArtjFragment extends BaseFragment{
    ...
    private void setData() {
        ...
        for (int i = 0; i < mbean.getResult().getChartData().getDay().getXData().size(); i++) {
            yVals1.add(new Entry(Float.parseFloat(mbean.getResult().getChartData().getDay().getXData().get(i)),
        ...
        for (int i = 0; i < mbean.getResult().getChartData().getDay().getXData().size(); i++) {
            yVals2.add(new Entry(Float.parseFloat(mbean.getResult().getChartData().getDay().getXData().get(i)),
                    Float.parseFloat(String.valueOf(mbean.getResult().getChartData().getDay().getSData().get(1).getValue().get(i)))));
        }

        ArrayList<Entry> yVals3 = new ArrayList<Entry>();

        for (int i = 0; i < mbean.getResult().getChartData().getDay().getXData().size(); i++) {
            yVals3.add(new Entry(Float.parseFloat(mbean.getResult().getChartData().getDay().getXData().get(i)),
                    Float.parseFloat(String.valueOf(mbean.getResult().getChartData().getDay().getSData().get(2).getValue().get(i)))));
        }
