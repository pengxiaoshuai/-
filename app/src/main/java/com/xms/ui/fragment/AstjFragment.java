...
public class AstjFragment extends BaseFragment {
    ...
    public void initData(){
        ...
        IAxisValueFormatter custom = new MyAxisValueFormatter(1);//定义的自定义X轴数据
...
//        setData(hour,10);
    ...
    private void setData(int count, float range) {
        ...
        if (mbarchart.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "每小时用电量(千瓦时)");
...
//            set1.setColors(ColorTemplate.MATERIAL_COLORS);
    ...
    private void setData() {
        ...
        for (int i= 0; i < mbean.getResult().getChartData().getHour().getXData().size(); i++){
            yVals1.add(new BarEntry(Integer.parseInt(mbean.getResult().getChartData().getHour().getXData().get(i)),
                    mbean.getResult().getChartData().getHour().getSData().get(i)));
        }
        ...
        if (mbarchart.getData() != null &&
            ...
            set1 = new BarDataSet(yVals1, "每小时用电量(kwh)");
