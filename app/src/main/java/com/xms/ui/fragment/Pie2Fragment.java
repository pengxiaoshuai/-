...
public class Pie2Fragment extends BaseFragment {
    private View mRootView;
    @BindView(R.id.piechart)
    PieChart mChart;
    @Override
    protected View initView(LayoutInflater inflater){
        mRootView = inflater.inflate(R.layout.fragment_pie2,null);
        return mRootView;
    }
...
//        colors.add(ColorTemplate.MATERIAL_COLORS[3]);
    ...
    private SpannableString generateCenterSpannableText() {
        SpannableString s = new SpannableString("3073.2\n元");
        s.setSpan(new RelativeSizeSpan(2.4f), 0, s.length()-2, 0); //字体大小，到第几位
