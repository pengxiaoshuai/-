...
public class PcbbAytjFragment extends BaseFragment {
    private View mRootView;
    @BindView(R.id.linechart)
    LineChart mChart;
    private Boolean islook = false; //是否第一次
    @Override
    ...
    private void setData() {
        ...
        for (int i = 0; i < mbean.getResult().getChartData().getMonth().getXData().size(); i++) {
            yVals1.add(new Entry(Float.parseFloat(String.valueOf(mbean.getResult().getChartData().getMonth().getXData().get(i))),
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new LineDataSet(yVals1, mbean.getResult().getChartData().getMonth().getYUnit());
