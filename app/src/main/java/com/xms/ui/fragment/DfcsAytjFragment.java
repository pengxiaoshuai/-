...
public class DfcsAytjFragment extends BaseFragment {
    ...
    public void setdata(DfcsBean mbean, int index) {
        ...
        if (islook) { //判断当前fragment是否被主页面加载过
            if (mbean.getResult().getChartData().getMonth().getSData().get(0).getValue().size()<=0){
                mChart.clear();
                mChart.invalidate();
                return;
            }
    ...
    private void setData1() {
        ...
        for (int i = 0; i < mbean.getResult().getChartData().getMonth().getXData().size(); i++) {
            yVals1.add(new Entry(Float.parseFloat(mbean.getResult().getChartData().getMonth().getXData().get(i)),
                    Float.parseFloat(String.valueOf(mbean.getResult().getChartData().getMonth().getSData().get(0).getValue().get(i)))));
        }
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new LineDataSet(yVals1, mbean.getResult().getChartData().getMonth().getSData().get(0).getName());
    ...
    private void setData() {
        ...
        for (int i = 0; i < mbean.getResult().getChartData().getMonth().getXData().size(); i++) {
            yVals2.add(new Entry(Float.parseFloat(mbean.getResult().getChartData().getMonth().getXData().get(i)),
                    Float.parseFloat(String.valueOf(mbean.getResult().getChartData().getMonth().getSData().get(1).getValue().get(i)))));
        }

        ArrayList<Entry> yVals3 = new ArrayList<Entry>();

        for (int i = 0; i < mbean.getResult().getChartData().getMonth().getXData().size(); i++) {
            yVals3.add(new Entry(Float.parseFloat(mbean.getResult().getChartData().getMonth().getXData().get(i)),
                    Float.parseFloat(String.valueOf(mbean.getResult().getChartData().getMonth().getSData().get(2).getValue().get(i)))));
        }
        ...
        if (mChart.getData() != null &&
            ...
            // create a dataset and give it a type
            set1 = new LineDataSet(yVals1, mbean.getResult().getChartData().getMonth().getSData().get(0).getName());
            set2 = new LineDataSet(yVals2, mbean.getResult().getChartData().getMonth().getSData().get(1).getName());
            set3 = new LineDataSet(yVals3, mbean.getResult().getChartData().getMonth().getSData().get(2).getName());
