...
public class InterfaceDefinition {
	...
	public static interface PreferencesUser {
		...
		public static final String SSGS="ssgs";//所属公司
		public static final String ZT="zt";//权限状态
		public static final String USERID="userId";//用户id
		public static final String USENAME="username";//用户名称
		public static final String COMPANYID="companyId";//companyid
		public static final String PERSONIMG = "personimg";// 头像
		public static final String SELECT = "myselect";// 类别
	...
	public interface IPath {
		public static final String BASE_URL = "http://rrsd.ewschina.com/store/";
		public static final String BASE_URL0 = "http://192.168.0.119:8889/store/";//10.10.0.203//http://192.168.0.4:8080/store/
		public static final String URL = "http://rrsd.ewschina.com/iegApp/"; //公网 http://192.168.0.119:8889/iegApp/  邱涛  http://192.168.0.123:8080/iegApp/
		// http://rrsd.ewschina.com/iegApp/



		// 肖海明 http://192.168.0.111:8080/iegApp/
		public static final String URL_WEBVIEW = "http://rrsd.ewschina.com/ieg/ver1.1/pages/profit-calculation/profit-calculation.html";
	}
