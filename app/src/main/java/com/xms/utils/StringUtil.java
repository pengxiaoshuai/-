...
public class StringUtil {
     ...
     * @return
     */
    public static String[] GetMyMessage2(String str, int index) {
        ...
        StringBuffer buffer=new StringBuffer(str); // 拆分字符为"," ,然后把结果交给数组strArray
        strArray[0]=buffer.substring(0,index);
        strArray[1]=buffer.substring(index,buffer.length());
        return strArray;
    }
    /**
     *通过什么来拆分 返回数组
     ...
     * @return
     */
    public static String GetMessage(String str,String replace){
     ...
     * @return
     */
    public static String GetStringMessage(String str, int end) {
       StringBuffer buffer=new StringBuffer(str);
        buffer.delete(buffer.length()-end,buffer.length());
