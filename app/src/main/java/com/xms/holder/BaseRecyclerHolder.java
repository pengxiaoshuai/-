...
public class BaseRecyclerHolder extends RecyclerView.ViewHolder {
     ...
     * 设置提示
     */
    public BaseRecyclerHolder setEdittextHint(int viewId,String text){
     ...
     * 设置字体背景色
     */
    public BaseRecyclerHolder setTextBackground(int viewId,int mcolor){
        TextView tv = getView(viewId);
     ...
     * 设置字体色
     */
    public BaseRecyclerHolder setTextColor(int viewId,int mcolor){
        TextView tv = getView(viewId);
